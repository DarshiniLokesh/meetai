...
export const DashboardNavbar = () =>{
    ...
    const [commanOpen,setCommandOpen] = useState(false);
    return(
        <>
        <DashboardCommand open={commanOpen} setOpen={setCommandOpen}/>
        <nav className="flex px-4 gap-x-2 items-center py-3 border-b bg-background">
            ...
            onClick={() =>{setCommandOpen((open) => !open)}}>
                <SearchIcon/>
                Search
                <kbd className="ml-auto pointer-events-none inline-flex h-5 slect-none items-center
